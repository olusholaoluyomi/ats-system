...
:::note[Source Code]
Every formula on this page maps directly to the scoring engine at [`src/lib/engine/scorer/`](https://github.com/olusholaoluyomi/ats-system-by-sunnypatell/tree/main/src/lib/engine/scorer). The weight vectors live in [`profiles/`](https://github.com/olusholaoluyomi/ats-system-by-sunnypatell/tree/main/src/lib/engine/scorer/profiles), format scoring in [`format-scorer.ts`](https://github.com/olusholaoluyomi/ats-system-by-sunnypatell/blob/main/src/lib/engine/scorer/format-scorer.ts), and keyword matching in [`keyword-matcher.ts`](https://github.com/olusholaoluyomi/ats-system-by-sunnypatell/blob/main/src/lib/engine/scorer/keyword-matcher.ts). It's all MIT-licensed if you want to dig in.
:::

:::tip[Going Deeper]
Curious where the platform weights, pass thresholds, and ATS quirks come from? The original research notes live in the repo at [`research/`](https://github.com/olusholaoluyomi/ats-system-by-sunnypatell/tree/main/research). It is the unfiltered source behind the numbers on this page.
:::
