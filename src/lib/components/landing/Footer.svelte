		...
		<div class="footer-top">
			...
			<div class="footer-brand">
				...
				<p class="brand-tagline">
					Free, open-source ATS resume screener that simulates real enterprise HCMS platforms. Built
					for job seekers who want real scores, not made-up numbers.
				</p>
...
<style>
	...
	.footer-pill.coffee-pill {
		border: 1px solid rgba(255, 221, 0, 0.3);
		color: #ffdd00;
	}

	.footer-pill.coffee-pill:hover {
		border-color: rgba(255, 221, 0, 0.5);
		background: rgba(255, 221, 0, 0.08);
	}

	.footer-pill.sponsor-pill {
		border: 1px solid rgba(219, 39, 119, 0.3);
		color: #ec4899;
	}

	.footer-pill.sponsor-pill:hover {
