				...
				<div class="fallback-toast">
					<div class="fallback-toast-left">
						...
						<p class="fallback-toast-msg">
							...
							want to check your resumes at the same time! the AI service is a little overwhelmed
							right now. your scores below are still accurate (rule-based analysis), but the AI
							suggestions/accuracy won't be as specific. try again later.
